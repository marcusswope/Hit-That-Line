...
namespace HitThatLine.Tests.Utility
{
    public class TestableMappingEngine : IMappingEngine
    {
        ...
        public object Map(object source, Type sourceType, Type destinationType)
        {
            ...
            return Mapper.Object.Map(source, sourceType, destinationType);
        }
    ...
    {
        private readonly List<Tuple<Type, Type>> _maps;
        public TestableConfigurationStore()
        {
            _maps = new List<Tuple<Type, Type>>();
        }
        ...
        {
            return _maps.FirstOrDefault(x => x.Item1 == source && x.Item2 == destination) != null;
        }
    }
